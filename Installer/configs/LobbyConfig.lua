...
--[[
	...
	ÉQUILIBRAGE : un 1er passage complet des 12 niveaux rapporte 329 trophées ;
	les rejouer en rapporte 25 %. Les 6 premières plaques tombent pendant la
	1re traversée, la 7e vers la fin du niveau 12, les deux dernières sont les
	objectifs long terme (farm de trophées après les 12 niveaux).
]]
LobbyConfig.SpeedTiers = table.freeze({
	...
	table.freeze({ Trophies = 40, Gain = 5 }),
	table.freeze({ Trophies = 100, Gain = 8 }),
	table.freeze({ Trophies = 220, Gain = 12 }),
	table.freeze({ Trophies = 450, Gain = 20 }),
	table.freeze({ Trophies = 800, Gain = 35 }),
