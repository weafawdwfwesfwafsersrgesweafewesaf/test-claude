...
--[[
	ÉQUILIBRAGE : coût ×2,1 à chaque rebirth, arrondi à deux chiffres pour un
	affichage propre (10K, 21K, 44K, 93K, 190K, 410K, 860K, 1,8M, 3,8M, 7,9M…).
	Le 1er arrive vers 15-20 min, le 12e (dernier tapis gratuit) vers 6-7 h.
]]
function UIConfig.RebirthCost(rebirths: number): number
	local raw = 10000 * 2.1 ^ math.max(0, rebirths)
	local step = 10 ^ (math.floor(math.log10(raw)) - 1)
...
UIConfig.Daily = {
	...
	{ Kind = "Speed", Amount = 500, Icon = "Speed", Label = "+500" },
...
UIConfig.Gifts = {
	...
	{ Minutes = 2, Kind = "Speed", Amount = 100, Icon = "GiftGreen" },
	{ Minutes = 3, Kind = "Coins", Amount = 500, Icon = "GiftRed" },
	{ Minutes = 4, Kind = "Speed", Amount = 250, Icon = "GiftPurple" },
	{ Minutes = 5, Kind = "Coins", Amount = 750, Icon = "GiftGreen" },
	{ Minutes = 8, Kind = "Coins", Amount = 1000, Icon = "GiftRed" },
	{ Minutes = 10, Kind = "Speed", Amount = 1000, Icon = "GiftPurple" },
	{ Minutes = 15, Kind = "Coins", Amount = 2000, Icon = "GiftGreen" },
	{ Minutes = 20, Kind = "Speed", Amount = 2500, Icon = "GiftRed" },
	{ Minutes = 30, Kind = "Coins", Amount = 3500, Icon = "GiftPurple" },
	{ Minutes = 45, Kind = "Speed", Amount = 10000, Icon = "GiftGreen" },
...
--[[
	...
	ÉQUILIBRAGE : clavier dès la 2e minute, volcan vers le 2e-3e rebirth (~30 min),
	cosmique vers 1 h 30 (les pièces repartent de zéro à chaque rebirth).
]]
UIConfig.Eggs = {
	{
	...
	{
		Id = "volcan", Name = "VOLCANO EGG", Model = "Oeuf_VolcanGlace", Price = 10000, Refund = 0.3,
		Chances = {
	...
	{
		Id = "cosmique", Name = "COSMIC EGG", Model = "Oeuf_Cosmique", Price = 150000, Refund = 0.3,
		Chances = {
