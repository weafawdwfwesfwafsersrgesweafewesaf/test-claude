...
--[[
	...
	ÉQUILIBRAGE (les pièces repartent de zéro à chaque rebirth) : on s'offre un
	vélo toutes les 20 à 60 min — Lava vers 10 min, Robot vers 1 h, Skeleton vers
	2 h, Retro vers 3 h, et le Ghost avec le jackpot du niveau 12 (~4 h).
...
local Bikes: { Item } = {
	...
	{ Id = "bike_lava", Name = "Lava", Category = "Bike", Price = 1500, Currency = "Coins", Rarity = Rarity.Common, Art = "BikeLava", Theme = "Lave", Skin = skin(rgb(255, 30, 0), rgb(255, 176, 0), { AccentMaterial = Enum.Material.Neon }) },
	{ Id = "bike_ice", Name = "Ice", Category = "Bike", Price = 5000, Currency = "Coins", Rarity = Rarity.Rare, Art = "BikeIce", Theme = "Glace", Skin = skin(rgb(42, 168, 255), rgb(191, 242, 255)) },
	{ Id = "bike_candy", Name = "Candy", Category = "Bike", Price = 12000, Currency = "Coins", Rarity = Rarity.Rare, Art = "BikeCandy", Theme = "BonbonGeant", Skin = skin(rgb(255, 79, 155), rgb(255, 216, 74)) },
	{ Id = "bike_robot", Name = "Robot", Category = "Bike", Price = 30000, Currency = "Coins", Rarity = Rarity.Rare, Art = "BikeRobot", Theme = "Robot", Skin = skin(rgb(29, 107, 214), rgb(53, 232, 255), { FrameMaterial = Enum.Material.Metal }) },
	{ Id = "bike_dragon", Name = "Dragon", Category = "Bike", Price = 75000, Currency = "Coins", Rarity = Rarity.Epic, Art = "BikeDragon", Theme = "Dragon", Skin = skin(rgb(179, 32, 15), rgb(255, 210, 26)) },
	{ Id = "bike_skeleton", Name = "Skeleton", Category = "Bike", Price = 150000, Currency = "Coins", Rarity = Rarity.Epic, Art = "BikeSkeleton", Theme = "Squelette", Skin = skin(rgb(243, 238, 222), rgb(57, 255, 106), { AccentMaterial = Enum.Material.Neon }) },
	{ Id = "bike_retro", Name = "Retro", Category = "Bike", Price = 350000, Currency = "Coins", Rarity = Rarity.Epic, Art = "BikeRetro", Theme = "Retro8bit", Skin = skin(rgb(255, 0, 77), rgb(255, 236, 39)) },
	{ Id = "bike_ghost", Name = "Ghost", Category = "Bike", Price = 800000, Currency = "Coins", Rarity = Rarity.Legendary, Art = "BikeGhost", Theme = "Fantome", Skin = skin(rgb(31, 158, 116), rgb(157, 255, 203), { AccentMaterial = Enum.Material.Neon }) },
...
local Trails: { Item } = {
	...
	{ Id = "trail_lava", Name = "Lava", Category = "Trail", Price = 900, Currency = "Coins", Rarity = Rarity.Common, Art = "TrailRed", Theme = "Lave" },
	{ Id = "trail_ice", Name = "Ice", Category = "Trail", Price = 3000, Currency = "Coins", Rarity = Rarity.Rare, Art = "TrailBlue", Theme = "Glace" },
	{ Id = "trail_candy", Name = "Candy", Category = "Trail", Price = 7500, Currency = "Coins", Rarity = Rarity.Rare, Art = "TrailPurple", Theme = "BonbonGeant", LevelRequired = 12 },
	{ Id = "trail_robot", Name = "Robot", Category = "Trail", Price = 18000, Currency = "Coins", Rarity = Rarity.Rare, Art = "TrailBlue", Theme = "Robot" },
	{ Id = "trail_dragon", Name = "Dragon", Category = "Trail", Price = 45000, Currency = "Coins", Rarity = Rarity.Epic, Art = "TrailYellow", Theme = "Dragon" },
	{ Id = "trail_skeleton", Name = "Skeleton", Category = "Trail", Price = 90000, Currency = "Coins", Rarity = Rarity.Epic, Art = "TrailGreen", Theme = "Squelette" },
	{ Id = "trail_retro", Name = "Retro", Category = "Trail", Price = 200000, Currency = "Coins", Rarity = Rarity.Epic, Art = "TrailRed", Theme = "Retro8bit" },
	{ Id = "trail_ghost", Name = "Ghost", Category = "Trail", Price = 500000, Currency = "Coins", Rarity = Rarity.Legendary, Art = "TrailGreen", Theme = "Fantome" },
...
local Auras: { Item } = {
	...
	{ Id = "aura_candy", Name = "Candy", Category = "Aura", Price = 10000, Currency = "Coins", Rarity = Rarity.Rare, Art = "AuraPurple", Theme = "BonbonGeant" },
	{ Id = "aura_robot", Name = "Robot", Category = "Aura", Price = 25000, Currency = "Coins", Rarity = Rarity.Rare, Art = "AuraBlue", Theme = "Robot" },
	{ Id = "aura_dragon", Name = "Dragon", Category = "Aura", Price = 60000, Currency = "Coins", Rarity = Rarity.Epic, Art = "AuraRed", Theme = "Dragon", LevelRequired = 22 },
	{ Id = "aura_skeleton", Name = "Skeleton", Category = "Aura", Price = 120000, Currency = "Coins", Rarity = Rarity.Epic, Art = "AuraGold", Theme = "Squelette" },
	{ Id = "aura_retro", Name = "Retro", Category = "Aura", Price = 275000, Currency = "Coins", Rarity = Rarity.Epic, Art = "AuraRed", Theme = "Retro8bit" },
	{ Id = "aura_ghost", Name = "Ghost", Category = "Aura", Price = 650000, Currency = "Coins", Rarity = Rarity.Legendary, Art = "AuraBlue", Theme = "Fantome" },
