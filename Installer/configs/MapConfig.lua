...
--[[
	...
	ÉQUILIBRAGE : portes multipliées (0 → 5 M, environ ×2,5 à ×3 par niveau) pour
	une partie de ~4 h. Seul, on atteint à peu près le niveau 6 ; les suivants
	demandent des rebirths (multiplicateur), des plaques (trophées) et des pets.
	SpeedCurveStat a suivi (ProgressionConfig) pour garder la vitesse réelle.
	Les attributs SpeedRequired des dossiers Level1..12 et les panneaux
	« Speed : X+ » de la map ont été mis aux mêmes valeurs.
]]
